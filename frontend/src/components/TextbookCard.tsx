  ...
  return (
    <div className="group relative">
      ...
      <button
        ...
        className="relative z-20 w-60 h-[360px] -rotate-1 rounded-none text-left transition-transform duration-300 hover:-translate-y-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-shelf-gold-light/80 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent group-hover:rotate-0"
        aria-label={`进入课程：${textbook.courseName}`}
      >
        {/* 书脊阴影 */}
        ...
        {/* 书封面 */}
        <div
          className="relative h-full rounded-r-2xl rounded-l-xl overflow-hidden shadow-book cursor-pointer"
          style={{
            background:
